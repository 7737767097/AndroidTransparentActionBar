...
//    private var bottomSheetBehavior: BottomSheetBehavior? = null
    ...
    private fun initViews() {
        bottomSheetBehavior = BottomSheetBehavior.from<View>(findViewById<View>(R.id.bottomSheetLayout))
        ...
        showBottomSheetDialogButton =
            findViewById<View>(R.id.show_bottom_sheet_dialog_button) as Button
    }
            ...
            override fun onStateChanged(bottomSheet: View, newState: Int) {
                ...
                when (newState) {
                    ...
                    BottomSheetBehavior.STATE_EXPANDED -> {
                        ...
                        val toolbar: Toolbar = findViewById<View>(R.id.customToolbar) as Toolbar
                        setSupportActionBar(toolbar)
                        supportActionBar?.setDisplayShowTitleEnabled(false)
                        supportActionBar?.setDisplayHomeAsUpEnabled(true)
                    }
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.collapse_bottom_sheet_button ->                 // Collapsing the bottom sheet
                bottomSheetBehavior?.setState(BottomSheetBehavior.STATE_COLLAPSED)

            R.id.expand_bottom_sheet_button ->                 // Expanding the bottom sheet
                bottomSheetBehavior?.setState(BottomSheetBehavior.STATE_EXPANDED)

            R.id.hide_bottom_sheet_button ->                 // Hiding the bottom sheet
                bottomSheetBehavior?.setState(BottomSheetBehavior.STATE_HIDDEN)

            R.id.show_bottom_sheet_dialog_button ->                 // Opening the Dialog Bottom Sheet
